...
const albums = [
  { album: 'dangerous woman', year: 1985, artist_id: 1 },
  { album: 'sweetener', year: 1985, artist_id: 1 },
  { album: 'drones', year: 1985, artist_id: 2 }
];
    ...
    return Promise.all(
      albums.map(album =>{
        return client.query(`
                ...
                VALUES ($1, $2, $3)
              `, [album.album, album.year, album.artist_id]);
      })
    );
  })
  .then(
